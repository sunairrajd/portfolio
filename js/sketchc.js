...
var rm;
var lexicon;
// var box = document.getElementById("mycan");
// var widthmycan = box.offsetWidth;
// var heightmycan = box.offsetHeight;
//
// resizeCanvas(widthmycan, widthmycan/1.6666667);
...
function myloca()
{
  ...
  //
  // }, function() {
  //     alert('Hello, Inorder to view the below art, please reload the page and allow access to location. :) ');
  // });
     ...
     // let a = navigator.geolocation.getCurrentPosition(showPosition);
       ...
       navigator.geolocation.getCurrentPosition(function(position) {
         ...
         draw();
           ...
           alert('Hello, Please allow access to location inorder to view the below art :) ');
       });
...
console.log(feelslikecircle);
  ...
  function mytime() {
    ...
    else if (hourslice >= 5 && hourslice < 6){
      samay = 'mid-night';
      setGradient(e1, e2);
    }

    else if (hourslice >= 6 && hourslice < 8){
       samay = 'early morning';
       setGradient(b1, b2);
    }
...
// let bbox = font.textBounds(haiku[i], 10, 160+(40*i), 36);
                    ...
                    textLeading(38);
                      ...
                      strokeWeight(1);
                          fill('white');
                      noStroke();
                      rect(15,160+(46*i)-30,textWidth(haiku[i]), 39);


                  //    noStroke();
                   fill(50,50,50);
                      text(haiku[i], 10, 160+(46*i));
